#!/usr/bin/python
import sys
sys.path.append('/home/mbrown/vm_setup')
            ...
            for line in re.findall('(.*)\n',c):
                ...
                if(re.search(cid,line)):
                    ...
                    if info[1] == 'in-use':
                        ...
                        break
        if f==1:
            mount_cmd="ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no ubuntu@" + vip + " \"sh /home/ubuntu/TOOLS/Scripts/utility/mount.sh REFS_" + bid + "\" exit;"
