...
sys.path.append('/home/mbrown/vmsetup')
...
def cleanup(cid, vid, bid, vip):
    ...
    unmount_cmd = "ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no ubuntu@" + vip \
                  + " \"sh -s\" < /home/mbrown/vm_setup/unmount.sh \"" + cname + "\""
