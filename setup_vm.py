...
def setup_vm(bid,image,flavor,key,wait):
    ...
    src_cmd='. /home/mbrown/.novarc;'
    vm = "vm_pipe_" + bid
    vid=''
    vm_boot=src_cmd + "nova boot " + vm + " --image " + image + " --flavor " + flavor + " --key-name " + key
    ...
    if(flag==1):
        ...
        delay='sleep 120s'
        sys.stderr.write(date_time() + 'Pausing 2 minutes to give vm a chance to initialize\n')
        subprocess.call(delay,shell=True)
        nova_var='ssh-keyscan ' + vip + ' >> ~/.ssh/known_hosts;rsync /home/mbrown/.novarc ubuntu@' + vip + ':/home/ubuntu'
